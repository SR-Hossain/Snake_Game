...
void gotoXY(int row, int col){
    CursorPosition.X = col + prevconsize[1]/2 - 21; 
    CursorPosition.Y = row + prevconsize[0]/2 - 10;
...
void gotoXY(int row, int col, string str){
    ...
    CursorPosition.X = col + changepos[1]/2 - 21; 
    CursorPosition.Y = row + changepos[0]/2 - 10;
    SetConsoleCursorPosition(console,CursorPosition); 
	cout<<str;
}
...
void key_press(){
    ...
    if(cs == 'w' and ch == 's')cs=ch;
    else if(cs == 's' and ch == 'w')cs=ch;
    else if(cs == 'a' and ch == 'd')cs=ch;
    else if(cs == 'd' and ch == 'a')cs=ch;
